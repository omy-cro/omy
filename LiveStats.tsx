  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        // Keep empty stats if the API is not configured yet.
      }
    }
    ...
    <>
      ...
      <section className="section" id="map">
        <div className="container">
          ...
          <p>
            Only approximate city-level information is used. Exact addresses and raw IP
            addresses are not stored for this visualization.
          </p>

          <div className="city-list">
            {stats.cities.length === 0 ? (
              <div className="city-row">
                <span>The first cities will appear here after confirmed payments.</span>
                <span>0</span>
              </div>
            ) : (
